        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MvrToUsdAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BtcAmount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrenyChain = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReceiveWalletAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RefernceNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    translationpicture = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuyCurrencies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MVRTOUSD = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxBuyLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BuyLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaxSellLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SellLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BuyConversionRate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SellConversionRate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Buydigit = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommesionOnChain = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoReceiverAddress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CryptoReceiverAddress_CryptoReceiverAddressDetails_ChainId",
                        column: x => x.ChainId,
            ...
            migrationBuilder.CreateTable(
                name: "multipleChainSelectionWithBuyChains",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_multipleChainSelectionWithBuyChains", x => x.Id);
                    table.ForeignKey(
                        name: "FK_multipleChainSelectionWithBuyChains_CurrencyMaster_CurrencyMasterId",
                        column: x => x.CurrencyMasterId,
                        principalTable: "CurrencyMaster",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CryptoReceiverAddress_ChainId",
                table: "CryptoReceiverAddress",
                column: "ChainId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_multipleChainSelectionWithBuyChains_CurrencyMasterId",
                table: "multipleChainSelectionWithBuyChains",
                column: "CurrencyMasterId");
        }
