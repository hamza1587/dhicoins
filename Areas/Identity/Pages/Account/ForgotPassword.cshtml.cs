...
namespace Dhicoin.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, IMailSender emailSender, IWebHostEnvironment env)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                var message = new Message(Input.Email, "Reset Password", messageBody);
