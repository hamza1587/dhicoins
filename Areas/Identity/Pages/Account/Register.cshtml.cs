        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var message = new Message(Input.Email, "Confirm your email", messageBody);
                    ...
                    //   $"Account Created.Activation Link Sent to your email.Activate your account by  <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
